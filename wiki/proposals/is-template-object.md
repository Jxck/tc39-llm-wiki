...
champion は [MSL](../people/MSL.md)(Mike Samuel)・[KOT](../people/KOT.md)(Krzysztof Kotowicz)・[JHD](../people/JHD.md)(Jordan Harband)・[ZTZ](../people/ZTZ.md)(Zbigniew Tenerowicz)。2026-05 に inactive 化されました。
...
| [2026-05](../../raw/notes/meetings/2026-05/may-19.md)     | **inactive 化に consensus**。実装側の需要・関心不足 + realm 関連の懸念                                                         | 2 → inactive |
...
> 横軸=2012-2026、縦軸=Stage。2019-06 に Stage 1 を経ず **直接 Stage 2** へ(議題は `for Stage 1 or 2`、結論は "Stage 2 acceptance")。以後 Stage 2 で長く停滞し、2024-07 に 2.7 を狙うも未達、2026-05 に inactive 化(線は 2026 で終端)。
...
実装側の必要性・関心が乏しく、加えて realm 関連の懸念が残ったため、proposal を inactive とすることに consensus。withdrawal に近い扱いです。
...
- [2026-05 may-19](../../raw/notes/meetings/2026-05/may-19.md) — inactive 化
