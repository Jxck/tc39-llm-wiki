...
```mermaid
gantt
    title Intl Era Month Code stage timeline
    dateFormat YYYY-MM
    axisFormat %Y
    todayMarker off
    Stage 1 : 2022-11, 2023-01
    Stage 2 : 2023-01, 2025-07
    Stage 2.7 : 2025-07, 2026-01
    Stage 3 : 2026-01, 2026-03
    Stage 4 : 2026-03, 2026-06
```

> 各 Stage の横棒 = その stage に居た期間(横軸 = 実時間)。2022-11 Stage 1 → 2023-01 Stage 2 →(約 2 年停滞)→ 2025-07 Stage 2.7 → 2026-01 Stage 3 → 2026-03 Stage 4(Temporal と同時)。
