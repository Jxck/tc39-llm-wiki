...
slug: modules
kind: family
members: [es-modules, dynamic-import, import-meta, top-level-await, import-attributes, json-modules, export-from, source-phase-imports, import-defer, import-text, esm-phase-imports, export-defer, export-all-from, module-scope-ceiling, module-declarations, compartments]
tags: [family, modules]
---
...
| `module-declarations`(module expressions/blocks) | 1(停滞)       | module をファイル外でインライン定義(`module { ... }`)。worker への受け渡し等が動機           |
