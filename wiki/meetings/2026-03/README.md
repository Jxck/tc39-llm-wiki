...
ECMA-262 / ECMA-402 の提案審議が中心の3日間。**Temporal が Stage 4 到達**(約5年の Stage 3 を経て出荷済み)、**Intl Era/Month Code も Stage 4**。Stage 2.7 へ Error Stack Accessor・RegExp Buffer Boundaries・Iterator Includes、Stage 3 へ Import Text・Intl Keep Trailing Zeros が進むなど多数の advancement があった。ほかに Abort Protocol / Structured Concurrency / Explicit Resource Management の Stage 4 条件付き状況、test262 のカバレッジ戦略、tree-shakeable methods などを議論。年次の chair/editor/convener 選挙も実施(冒頭で新たに 262 editor が増員)。
